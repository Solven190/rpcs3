...
"%CMAKE_EXE%" -S "%~dp0.." -B "%BUILD_DIR%" -G Ninja ^
  ...
  "-DCROSS_TOOLCHAIN_FLAGS_NATIVE=-DCMAKE_C_COMPILER=%MINGW%\gcc.exe;-DCMAKE_CXX_COMPILER=%MINGW%\g++.exe;-DCMAKE_C_COMPILER_LAUNCHER=ccache;-DCMAKE_CXX_COMPILER_LAUNCHER=ccache" ^
  %*
exit /b %ERRORLEVEL%
